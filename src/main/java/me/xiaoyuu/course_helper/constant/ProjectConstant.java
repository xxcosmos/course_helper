package me.xiaoyuu.course_helper.constant;

public final class ProjectConstant {
    public static final String BASE_PACKAGE = "me.xiaoyuu.course_helper";
    public static final String MODEL_PACKAGE = BASE_PACKAGE + ".model";//生成的Model所在包
    public static final String MAPPER_PACKAGE = BASE_PACKAGE + ".dao";//生成的dao所在包
